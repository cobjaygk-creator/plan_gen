...
1. core_issues (핵심 이슈, 3~5개): 오늘 업계에서 가장 중요한 사건/발표/흐름.
   ...
   - summary: 2~3문장의 자연스러운 브리핑 문장. "제목: 요약" 식으로 딱딱하게
     나열하지 말고, 날씨 캐스터가 브리핑하듯 사건을 서술한 뒤 마지막 문장에서
     왜 중요한지·시사점을 화자의 해석처럼 덧붙여라. title에 해당하는 핵심
     사실은 summary의 첫 문장에 자연스럽게 녹여 써라 (예: "지스타 2026이
     크림과 손잡았습니다. ~~~해서, ~~~인 점에서 지켜볼 만합니다.")
...
_CATEGORY_PRIORITY = {
    ...
    "AI": (
        ...
        "뉴스도 게임 산업과의 접점이 없다는 이유만으로 배제하지 마라."
    ),
}
