 ...
 * "02 메뉴 구조" 결정). 오늘/이슈/트렌드 are wired (Phase 1+2); 뉴스·기술
 * 레이더 render disabled as a placeholder for where that IA attaches later,
